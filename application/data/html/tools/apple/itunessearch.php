...
<!-- -------------------- ヘッダ --------------------------- -->
<header>
<h1><a href="<?= $rootUrl ?>"><span><img src="img/logo_app.png" /></span><?= $site_title ?></a></h1>
...
<!--	<div style="background:#000; padding:5px 0 5px 2px;"> -->
		...
		<select name="entity" class="input_entity">
		...
		<input type="search" name="kw" value="<?= htmlspecialchars( $term )?>" class="searchbar" />
		<input style="margin-left: 30px;" type="submit" value="アプリ検索"/ class="submit">
	</div>
...
<footer>
Presented by <a href="http://dev.ontheroad.jp" target="_blank">MacBook Air と WordPress でこうなった</a>
</footer>
